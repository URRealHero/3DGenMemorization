...
# - Manifest CSV logging (optional)
# - z_scale_factor: CLI override -> restore from ckpt -> (optional) STD from calibration -> VAE -> default
# - Conditioner loading policy (--cond_from_ckpt_mode): auto/always/never
#   auto => load cond only for LVIS class conditioning; skip for text/image
# - NEW: image conditioning from 12-view vertical sprite in CSV column 'view_path'
