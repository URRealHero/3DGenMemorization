...
# Assuming these exist in your .utils package
...
def export_to_trimesh(mesh_output):
    ...
    def _one(mo):
        if mo is None:
            return None
        # Fix face orientation for visualization
